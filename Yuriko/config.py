...
class Config(object):
    ...
    API_ID = 12388301  # integer value, dont use ""
    ...
    INFOPIC = True
    URL = None
    SPAMWATCH_API = "aCOc7Ah6AEU2uI6nGgHPMc20M5SFMQAF06PObKEM2YgKor0KuijUVA_kbZumOIqT"  # go to support.spamwat.ch to get key
    ...
    CASH_API_KEY = (
        "QOU31ON3L4APGUJ2"   # Get your API key from https://www.alphavantage.co/support/#api-key
    )
